#ifndef HTTPDigestCredentials_INCLUDED
#define HTTPDigestCredentials_INCLUDED
...
public:
	...
	void authenticate(clients::http::Request& request, const clients::http::Response& response);
		/// Parses WWW-Authenticate header of the clients::http::Response, initializes
		/// internal state, and adds authentication information to the given clients::http::Request.

	void authenticate(clients::http::Request& request, const HTTPAuthenticationParams& responseAuthParams);
		...
		/// information to the given clients::http::Request.
		///
	...
	void updateAuthInfo(clients::http::Request& request);
		/// Updates internal state and adds authentication information to
		/// the given clients::http::Request.

	void proxyAuthenticate(clients::http::Request& request, const clients::http::Response& response);
		/// Parses Proxy-Authenticate header of the clients::http::Response, initializes
		/// internal state, and adds proxy authentication information to the given clients::http::Request.

	void proxyAuthenticate(clients::http::Request& request, const HTTPAuthenticationParams& responseAuthParams);
		/// Initializes internal state according to information from the
	...
	void updateProxyAuthInfo(clients::http::Request& request);
		/// Updates internal state and adds proxy authentication information to
		/// the given clients::http::Request.

	bool verifyAuthInfo(const clients::http::Request& request) const;
		/// Verifies the digest authentication information in the given clients::http::Request
	...
	bool verifyAuthParams(const clients::http::Request& request, const HTTPAuthenticationParams& params) const;
		/// Verifies the digest authentication information in the given clients::http::Request
...
private:
	...
	void createAuthParams(const clients::http::Request& request, const HTTPAuthenticationParams& responseAuthParams);
	void updateAuthParams(const clients::http::Request& request);
	...
	static Poco::FastMutex _nonceMutex; // userver::mutex???
};
...
#endif // HTTPDigestCredentials_INCLUDED